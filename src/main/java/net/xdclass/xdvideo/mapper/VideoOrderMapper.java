...
public interface VideoOrderMapper {
     ...
     * @return
     */
    @Select("select * from video_order where out_trade_no=#{out_trade_no} and del=0 and state=1")
    VideoOrder findTrueByOutTradeNo(@Param("out_trade_no") String outTradeNo);
